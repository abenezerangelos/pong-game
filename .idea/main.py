...
while the_ball.xcor()<400 and the_ball.xcor()>-400:
   ...
   if ball.ycor() >= 300 or ball.ycor() <= -300:
    if turnt == True:
      turnt=ball.bounce_back()
      print(turnt)

   angle=the_ball.heading()
   if (0.0<math.fabs(the_ball.ycor()-lpaddle.paddle.ycor())<100.0 and -21.0<the_ball.xcor()-lpaddle.paddle.xcor()<21.0):
       the_ball.setheading(180 + angle)
       print("!!!!!!")
       turnt=True
   if (0.0<math.fabs(the_ball.ycor()-rpaddle.paddle.ycor())<100.0 and -21.0<the_ball.xcor()-rpaddle.paddle.xcor()<21.0):
       the_ball.setheading(180 + angle)
       print("!!!!!!")
